package frc.robot.yams.mechanisms.config;
...
import frc.robot.yams.exceptions.DifferentialMechanismConfigurationException;
import frc.robot.yams.gearing.GearBox;
import frc.robot.yams.gearing.MechanismGearing;
import frc.robot.yams.mechanisms.config.MechanismPositionConfig.Plane;
import frc.robot.yams.mechanisms.positional.DifferentialMechanism;
...
public class DifferentialMechanismConfig {
    ...
    protected boolean simOverride = false;
    ...
    public DifferentialMechanismConfig withSimOverride(boolean simOverride){
        this.simOverride = simOverride;
        return this;
    }
    
    public boolean getSimOverride(){
        return simOverride;
    }
