...
import frc.robot.yams.exceptions.ArmConfigurationException;
import frc.robot.yams.gearing.MechanismGearing;
import frc.robot.yams.mechanisms.config.ArmConfig;
...
import frc.robot.yams.motorcontrollers.simulation.ArmSimSupplier;
...
public class Arm extends SmartPositionalMechanism
{
  ...
  public Arm(ArmConfig config)
  {
    ...
    if (RobotBase.isSimulation()||config.getSimOverride())
    {
