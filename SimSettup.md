...
newest NI game tools (if on windows)
...
If this does not work make sure that A) You are using WPIlib vscode and not normal vscode and B) The code is open in the correct directory (VScode should show files like build.gradle in the root directory).
